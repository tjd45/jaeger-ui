...
import * as markers from './SearchTomForm.markers';
import { trackFormInput } from './SearchTomForm.track';
...
// COME HERE
export class SearchTomFormImpl extends React.PureComponent {
    render() {
        const {
            handleSubmit,
            invalid,
...
SearchTomFormImpl.defaultProps = {
    invalid: false,
    services: [],
    submitting: false,
